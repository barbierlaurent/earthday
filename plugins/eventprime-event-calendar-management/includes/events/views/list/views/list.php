        ...
        <div class="ep-event-list-item ep-bg-white ep-border ep-rounded ep-mb-4 ep-text-small">
         <div class="ep-box-row ep-m-0">
            ...
            <div class="ep-box-col-3 ep-box-list-right-col ep-px-0 ep-pt-4 ep-rounded-tbr-right ep-overflow-hidden ep-border-left ep-position-relative">
                <div class="ep-px-2 ep-text-end ep-list-view-pricing-area">
                ...
                <div class="ep-align-self-end ep-list-view-btn-area ep-position-absolute ep-p-2 ep-bg-white ep-box-w-100" style="bottom:0">
